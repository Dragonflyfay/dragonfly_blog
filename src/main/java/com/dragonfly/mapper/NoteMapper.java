...
public interface NoteMapper {
    ...
    @Select("SELECT n.*, COALESCE(NULLIF(u.nickname, ''), u.username) AS create_user_name, u.user_pic AS create_user_avatar " +
    ...
    @Select("<script>" +
            "SELECT n.*, COALESCE(NULLIF(u.nickname, ''), u.username) AS create_user_name, u.user_pic AS create_user_avatar " +
